...
{
   public partial class TT_LoadWeightEditLogBLL:ITT_LoadWeightEditLogService
    {
       private readonly ITT_LoadWeightEditLog dal=DataAccess.CreateTT_LoadWeightEditLog();
       public TT_LoadWeightEditLogBLL()
		{}
        ...
        public TT_LoadWeightEditLog DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_LoadWeightEditLog> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_LoadWeightEditLog> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_LoadWeightEditLog> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_LoadWeightEditLog>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_LoadWeightEditLog model;
