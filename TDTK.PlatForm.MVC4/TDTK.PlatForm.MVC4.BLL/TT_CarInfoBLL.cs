...
{
   public partial class TT_CarInfoBLL:ITT_CarInfoService
    {
       private readonly ITT_CarInfo dal=DataAccess.CreateTT_CarInfo();
       public TT_CarInfoBLL()
		{}
        ...
        public TT_CarInfo DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_CarInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_CarInfo> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_CarInfo> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_CarInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_CarInfo model;
