...
{
   public partial class TT_RoomSuperviseBLL:ITT_RoomSuperviseService
    {
       private readonly ITT_RoomSupervise dal=DataAccess.CreateTT_RoomSupervise();
       public TT_RoomSuperviseBLL()
		{}
        ...
        public TT_RoomSupervise DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_RoomSupervise> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_RoomSupervise> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_RoomSupervise> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_RoomSupervise>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_RoomSupervise model;
