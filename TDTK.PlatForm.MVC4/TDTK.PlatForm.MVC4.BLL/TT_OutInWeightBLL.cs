...
namespace TDTK.PlatForm.MVC4.BLL
{
    ...
    public partial class TT_OutInWeightBLL : ITT_OutInWeightService
    {
        private readonly ITT_OutInWeight dal=DataAccess.CreateTT_OutInWeight();
        public TT_OutInWeightBLL()
		{}
        ...
        public TT_OutInWeight DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_OutInWeight> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_OutInWeight> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_OutInWeight> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_OutInWeight>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_OutInWeight model;
