...
{
    public partial class TT_TaxOutItemDetailBLL:ITT_TaxOutItemDetailService
    {
        private readonly ITT_TaxOutItemDetail dal=DataAccess.CreateTT_TaxOutItemDetail();
        public TT_TaxOutItemDetailBLL()
		{}
        ...
        public TT_TaxOutItemDetail DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_TaxOutItemDetail> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_TaxOutItemDetail> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_TaxOutItemDetail> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_TaxOutItemDetail>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_TaxOutItemDetail model;
