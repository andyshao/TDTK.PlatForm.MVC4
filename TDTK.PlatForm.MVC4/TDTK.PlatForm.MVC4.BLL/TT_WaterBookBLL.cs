...
{
   public partial class TT_WaterBookBLL:ITT_WaterBookService
    {
       private readonly ITT_WaterBook dal=DataAccess.CreateTT_WaterBook();
       public TT_WaterBookBLL()
		{}
        ...
        public TT_WaterBook DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_WaterBook> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_WaterBook> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_WaterBook> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_WaterBook>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_WaterBook model;
