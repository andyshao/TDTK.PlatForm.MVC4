...
{
    public partial class TT_OutLoadWeightBLL : ITT_OutLoadWeightService
    {
        private readonly ITT_OutLoadWeight dal=DataAccess.CreateTT_OutLoadWeight();
        public TT_OutLoadWeightBLL()
		{}
        ...
        public TT_OutLoadWeight DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_OutLoadWeight> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_OutLoadWeight> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_OutLoadWeight> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_OutLoadWeight>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_OutLoadWeight model;
