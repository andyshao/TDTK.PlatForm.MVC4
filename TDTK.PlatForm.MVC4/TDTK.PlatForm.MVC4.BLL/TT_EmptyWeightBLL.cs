...
{
   public partial class TT_EmptyWeightBLL:ITT_EmptyWeightService
    {
       private readonly ITT_EmptyWeight dal=DataAccess.CreateTT_EmptyWeight();
       public TT_EmptyWeightBLL()
		{}
        ...
        public TT_EmptyWeight DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_EmptyWeight> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_EmptyWeight> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_EmptyWeight> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_EmptyWeight>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_EmptyWeight model;
