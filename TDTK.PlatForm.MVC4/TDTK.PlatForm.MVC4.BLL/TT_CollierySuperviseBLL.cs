...
{
   public partial class TT_CollierySuperviseBLL:ITT_CollierySuperviseService
    {
       private readonly ITT_CollierySupervise dal=DataAccess.CreateTT_CollierySupervise();
       public TT_CollierySuperviseBLL()
		{}
        ...
        public TT_CollierySupervise DataRowToModel(DataRow row)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_CollierySupervise> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TDTK.PlatForm.MVC4.Model.TT_CollierySupervise> DataTableToList(DataTable dt)
        {
            List<TDTK.PlatForm.MVC4.Model.TT_CollierySupervise> modelList = new List<TDTK.PlatForm.MVC4.Model.TT_CollierySupervise>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TDTK.PlatForm.MVC4.Model.TT_CollierySupervise model;
