...
{
    /// <summary>
    /// 数据访问类:TT_TaxItemDetail
    /// </summary>
    public partial class TT_TaxItemDetail : ITT_TaxItemDetail
    {
        public TT_TaxItemDetail()
        { }

        public bool Exists(Model.TT_TaxItemDetail t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from TT_TaxItemDetail");
        ...
        public int Add(Model.TT_TaxItemDetail t)
        {
            StringBuilder strSql = new StringBuilder();
       ...
       /// <summary>
        ...
        public bool Delete(Model.TT_TaxItemDetail t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TT_TaxItemDetail ");
            strSql.Append(" where ItemDetailId=@ItemDetailId");
            SqlParameter[] parameters = {
					new SqlParameter("@ItemDetailId", SqlDbType.BigInt)
			};
        ...
        public bool DeleteList(string IDlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TT_TaxItemDetail ");
            strSql.Append(" where ItemDetailId in (" + IDlist + ")  ");
        ...
        public Model.TT_TaxItemDetail GetModel(Model.TT_TaxItemDetail t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ItemDetailId,CoalKindCode,RoomCode,TaxItemCode,Amount,EffectTime,Operator,OperateTime,TaxGroup,IsAssigned,IsAll from TT_TaxItemDetail ");
            strSql.Append(" where ItemDetailId=@ItemDetailId");
            SqlParameter[] parameters = {
					new SqlParameter("@ItemDetailId", SqlDbType.BigInt)
			};
            ...
            TDTK.PlatForm.MVC4.Model.TT_TaxItemDetail model = new TDTK.PlatForm.MVC4.Model.TT_TaxItemDetail();
        ...
        /// 得到一个对象实体
        /// </summary>
        public TDTK.PlatForm.MVC4.Model.TT_TaxItemDetail DataRowToModel(DataRow row)
        {
            TDTK.PlatForm.MVC4.Model.TT_TaxItemDetail model = new TDTK.PlatForm.MVC4.Model.TT_TaxItemDetail();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM TT_TaxItemDetail ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TT_TaxItemDetail T ");
