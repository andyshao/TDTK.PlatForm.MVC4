...
{
    /// <summary>
    /// 数据访问类:TT_LoadWeightBackup
    /// </summary>
    public partial class TT_LoadWeightBackup : ITT_LoadWeightBackup
    {
        public TT_LoadWeightBackup()
        { }

        public bool Exists(Model.TT_LoadWeightBackup t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from TT_LoadWeightBackup");
        ...
        public int Add(Model.TT_LoadWeightBackup t)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@UpdateOperator", SqlDbType.NVarChar,20),
            ...
            parameters[34].Value = t.UpdateOperator;
            parameters[35].Value = t.UpdateTime;
        ...
        public bool Update(Model.TT_LoadWeightBackup t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TT_LoadWeightBackup set ");
            ...
            strSql.Append("UpdateOperator=@UpdateOperator,");
        ...
        public bool Delete(Model.TT_LoadWeightBackup t)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TT_LoadWeightBackup ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,WeightCode,TrafficCode,NavicertCode,MarkedCardCode,RemoteCardCode,EmptyCode,CollCode,CollName,CoalKindCode,CoalKindName,CarOwnerName,CarNo,CarType,LoadWeight,EmptyWeight,NetWeight,OverWeight,TaxAmount,FundAmount,RoomCode,RoomName,BangType,Operator,WeightTime,RandomCode,CustomerName,TaxType,IsFirstSite,FrontImage,BackImage,UpImage,RoomImage,TaxGroup,IsSealed,UpdateOperator,UpdateTime ");
            strSql.Append(" FROM TT_LoadWeightBackup ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,WeightCode,TrafficCode,NavicertCode,MarkedCardCode,RemoteCardCode,EmptyCode,CollCode,CollName,CoalKindCode,CoalKindName,CarOwnerName,CarNo,CarType,LoadWeight,EmptyWeight,NetWeight,OverWeight,TaxAmount,FundAmount,RoomCode,RoomName,BangType,Operator,WeightTime,RandomCode,CustomerName,TaxType,IsFirstSite,FrontImage,BackImage,UpImage,RoomImage,TaxGroup,IsSealed,UpdateOperator,UpdateTime ");
            strSql.Append(" FROM TT_LoadWeightBackup ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TT_LoadWeightBackup T ");
